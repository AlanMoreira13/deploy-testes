 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(N,O){var M=N.length;N.push(O);e:for(;0<M;){var q=M-1>>>1,oe=N[q];if(0<o(oe,O))N[q]=O,N[M]=oe,M=q;else break e}}function n(N){return N.length===0?null:N[0]}function r(N){if(N.length===0)return null;var O=N[0],M=N.pop();if(M!==O){N[0]=M;e:for(var q=0,oe=N.length,Lr=oe>>>1;q<Lr;){var Vt=2*(q+1)-1,Mi=N[Vt],Ut=Vt+1,Rr=N[Ut];if(0>o(Mi,M))Ut<oe&&0>o(Rr,Mi)?(N[q]=Rr,N[Ut]=M,q=Ut):(N[q]=Mi,N[Vt]=M,q=Vt);else if(Ut<oe&&0>o(Rr,M))N[q]=Rr,N[Ut]=M,q=Ut;else break e}}return O}function o(N,O){var M=N.sortIndex-O.sortIndex;return M!==0?M:N.id-O.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var l=Date,a=l.now();e.unstable_now=function(){return l.now()-a}}var s=[],c=[],p=1,m=null,h=3,w=!1,g=!1,y=!1,z=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,u=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function d(N){for(var O=n(c);O!==null;){if(O.callback===null)r(c);else if(O.startTime<=N)r(c),O.sortIndex=O.expirationTime,t(s,O);else break;O=n(c)}}function v(N){if(y=!1,d(N),!g)if(n(s)!==null)g=!0,Pi(k);else{var O=n(c);O!==null&&Oi(v,O.startTime-N)}}function k(N,O){g=!1,y&&(y=!1,f(P),P=-1),w=!0;var M=h;try{for(d(O),m=n(s);m!==null&&(!(m.expirationTime>O)||N&&!He());){var q=m.callback;if(typeof q=="function"){m.callback=null,h=m.priorityLevel;var oe=q(m.expirationTime<=O);O=e.unstable_now(),typeof oe=="function"?m.callback=oe:m===n(s)&&r(s),d(O)}else r(s);m=n(s)}if(m!==null)var Lr=!0;else{var Vt=n(c);Vt!==null&&Oi(v,Vt.startTime-O),Lr=!1}return Lr}finally{m=null,h=M,w=!1}}var E=!1,$=null,P=-1,Z=5,I=-1;function He(){return!(e.unstable_now()-I<Z)}function An(){if($!==null){var N=e.unstable_now();I=N;var O=!0;try{O=$(!0,N)}finally{O?Dn():(E=!1,$=null)}}else E=!1}var Dn;if(typeof u=="function")Dn=function(){u(An)};else if(typeof MessageChannel<"u"){var ds=new MessageChannel,Nd=ds.port2;ds.port1.onmessage=An,Dn=function(){Nd.postMessage(null)}}else Dn=function(){z(An,0)};function Pi(N){$=N,E||(E=!0,Dn())}function Oi(N,O){P=z(function(){N(e.unstable_now())},O)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(N){N.callback=null},e.unstable_continueExecution=function(){g||w||(g=!0,Pi(k))},e.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Z=0<N?Math.floor(1e3/N):5},e.unstable_getCurrentPriorityLevel=function(){return h},e.unstable_getFirstCallbackNode=function(){return n(s)},e.unstable_next=function(N){switch(h){case 1:case 2:case 3:var O=3;break;default:O=h}var M=h;h=O;try{return N()}finally{h=M}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(N,O){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var M=h;h=N;try{return O()}finally{h=M}},e.unstable_scheduleCallback=function(N,O,M){var q=e.unstable_now();switch(typeof M=="object"&&M!==null?(M=M.delay,M=typeof M=="number"&&0<M?q+M:q):M=q,N){case 1:var oe=-1;break;case 2:oe=250;break;case 5:oe=1073741823;break;case 4:oe=1e4;break;default:oe=5e3}return oe=M+oe,N={id:p++,callback:O,priorityLevel:N,startTime:M,expirationTime:oe,sortIndex:-1},M>q?(N.sortIndex=M,t(c,N),n(s)===null&&N===n(c)&&(y?(f(P),P=-1):y=!0,Oi(v,M-q))):(N.sortIndex=oe,t(s,N),g||w||(g=!0,Pi(k))),N},e.unstable_shouldYield=He,e.unstable_wrapCallback=function(N){var O=h;return function(){var M=h;h=O;try{return N.apply(this,arguments)}finally{h=M}}}})(Qu);(function(e){e.exports=Qu})(Wu);/**
 * @license React
...
`;var Om={};Ze(Om,"Reveal",()=>xe);const Mm=S`
  from {
    opacity: 0;
  }
...
`,Ym=In`
  ...
  white-space: pre;
`,xe=e=>{const{cascade:t=!1,damping:n=.5,delay:r=0,duration:o=1e3,fraction:i=0,keyframes:l=fs,triggerOnce:a=!1,css:s,className:c,style:p,childClassName:m,childStyle:h,children:w,onVisibilityChange:g}=e,y=L.exports.useMemo(()=>Hm({keyframes:l,duration:o}),[o,l]);return Wm(w)?null:Qm(w)?B(bm,{...e,animationStyles:y,children:String(w)}):hd.exports.isFragment(w)?B(Xm,{...e,animationStyles:y}):B(om,{children:L.exports.Children.map(w,(z,f)=>{if(!L.exports.isValidElement(z))return null;const u=[s,y],d=r+(t?f*o*n:0);switch(z.type){case"ol":case"ul":return B(ll,{children:({cx:v})=>B(z.type,{...z.props,className:v(c,z.props.className),style:{...p,...z.props.style},children:B(xe,{...e,children:z.props.children})})});case"li":return B(Iu,{threshold:i,triggerOnce:a,onChange:g,children:({inView:v,ref:k})=>B(ll,{children:({cx:E})=>B(z.type,{...z.props,ref:k,className:E(m,z.props.className),css:v?u:Bo,style:{...h,...z.props.style,animationDelay:d+"ms"}})})});default:return B(Iu,{threshold:i,triggerOnce:a,onChange:g,children:({inView:v,ref:k})=>B("div",{ref:k,className:c,css:v?u:Bo,style:{...p,animationDelay:d+"ms"},children:B(ll,{children:({cx:E})=>B(z.type,{...z.props,className:E(m,z.props.className),style:{...h,...z.props.style}})})})})}})})},bm=e=>{const{animationStyles:t,cascade:n=!1,damping:r=.5,delay:o=0,duration:i=1e3,fraction:l=0,triggerOnce:a=!1,css:s,className:c,style:p,children:m,onVisibilityChange:h}=e,{ref:w,inView:g}=md({triggerOnce:a,threshold:l,onChange:h});return n?B("div",{ref:w,className:c,css:[s,Ym],style:p,children:m.split("").map((y,z)=>B("span",{css:g?t:Bo,style:{animationDelay:o+z*i*r+"ms"},children:y},z))}):B(xe,{...e,children:m})},Xm=e=>{const{animationStyles:t,fraction:n=0,triggerOnce:r=!1,css:o,className:i,style:l,children:a,onVisibilityChange:s}=e,{ref:c,inView:p}=md({triggerOnce:r,threshold:n,onChange:s});return B("div",{ref:c,className:i,css:p?[o,t]:Bo,style:l,children:a})};function Km(e){switch(e){case"flash":return[gm];case"headShake":return[wm,{animationTimingFunction:"ease-in-out"}];case"heartBeat":return[xm,{animationTimingFunction:"ease-in-out"}];case"jello":return[Sm,{transformOrigin:"center"}];case"pulse":return[km,{animationTimingFunction:"ease-in-out"}];case"rubberBand":return[$m];case"shake":return[Cm];case"shakeX":return[Em];case"shakeY":return[_m];case"swing":return[Nm,{transformOrigin:"top center"}];case"tada":return[zm];case"wobble":return[Pm];case"bounce":default:return[ym,{transformOrigin:"center bottom"}]}}const Gm=e=>{const{effect:t="bounce",...n}=e,[r,o]=L.exports.useMemo(()=>Km(t),[t]);return B(xe,{keyframes:r,css:o,...n})};var gd={};Ze(gd,"Bounce",()=>sh);const Zm=S`
  from,
  20%,
  40%,
  60%,
...
`;function kh(e,t,n){switch(n){case"bottom-left":return t?ch:Tm;case"bottom-right":return t?fh:Lm;case"down":return e?t?ph:Im:t?dh:Rm;case"left":return e?t?hh:Am:t?mh:fs;case"right":return e?t?yh:Fm:t?vh:Dm;case"top-left":return t?gh:jm;case"top-right":return t?wh:Vm;case"up":return e?t?Sh:Bm:t?xh:Um;default:return t?uh:Mm}}const $h=e=>{const{big:t=!1,direction:n,reverse:r=!1,...o}=e,i=L.exports.useMemo(()=>kh(t,r,n),[t,n,r]);return B(xe,{keyframes:i,...o})};var xd={};Ze(xd,"Flip",()=>Mh);const Ch=S`
  from {
...
`,Mh=e=>{const{direction:t,reverse:n=!1,...r}=e,o=L.exports.useMemo(()=>Ph(n,t),[t,n]);return B(xe,{css:Oh,keyframes:o,...r})};var Sd={};Ze(Sd,"Hinge",()=>Dh);const Th=S`
  0% {
...
`,Dh=e=>B(xe,{css:Ah,keyframes:Th,...e});var kd={};Ze(kd,"JackInTheBox",()=>Fh);const Fh=e=>B(xe,{keyframes:Lh,...e});var $d={};Ze($d,"Roll",()=>Vh);function jh(e){return e?Ih:Rh}const Vh=e=>{const{reverse:t=!1,...n}=e,r=L.exports.useMemo(()=>jh(t),[t]);return B(xe,{keyframes:r,...n})};var Cd={};Ze(Cd,"Rotate",()=>qh);const Uh=S`
  from {
...
`;function wv(e,t){switch(t){case"down":return e?hv:cv;case"left":return e?vv:fv;case"right":return e?yv:dv;case"up":return e?gv:pv;default:return e?mv:uv}}const xv=e=>{const{direction:t,reverse:n=!1,...r}=e,o=L.exports.useMemo(()=>wv(n,t),[t,n]);return B(xe,{keyframes:o,...r})};at(st,yd);at(st,gd);at(st,wd);at(st,xd);at(st,Sd);at(st,kd);at(st,$d);at(st,Cd);at(st,Ed);at(st,_d);const Sv=()=>C("div",{children:T("section",{id:"areasDeAtuacao",className:"sectionAreasDeAtuacao",children:[T("div",{className:"cartao card-1",children:[T("div",{className:"tituloComIcones",children:[C(ol,{className:"icon"}),C("h2",{children:"Direito Trabalhista"}),C(s1,{className:"icon iconMala"})]}),C("p",{className:"descricao",children:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum officiis, excepturi id vel amet repellendus reiciendis rem dolorum minima nemo. Repellendus aut inventore nihil dolore quas voluptatibus deleniti doloribus! Esse!"})]}),T("div",{className:"cartao card-2",children:[T("div",{className:"tituloComIcones",children:[C(ol,{className:"icon"}),C("h2",{children:"Direito Tribut\xE1rio"}),C(f1,{className:"icon"})]}),C("p",{className:"descricao",children:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum officiis, excepturi id vel amet repellendus reiciendis rem dolorum minima nemo. Repellendus aut inventore nihil dolore quas voluptatibus deleniti doloribus! Esse!"})]}),T("div",{className:"cartao card-3",children:[T("div",{className:"tituloComIcones",children:[C(ol,{className:"icon"}),C("h2",{children:"Direito de Fam\xEDlia"}),C(u1,{className:"icon"})]}),C("p",{className:"descricao",children:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum officiis, excepturi id vel amet repellendus reiciendis rem dolorum minima nemo. Repellendus aut inventore nihil dolore quas voluptatibus deleniti dddoloribus! Esse!"})]}),T("div",{className:"footerAreas",children:[C("h1",{className:"testeH2",children:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus . Quia?"}),C("p",{children:"Lorem ipsum dolor sit amet consectetur, adipisicing elit. Obcaecati placeat est facilis consequuntur delectus sit esse laboriosam voluptatum nesciunt velit. Dolore fugiat ullam cum animi, maxime nobis praesentium dolorum numquam.lorm Lorem ipsum dolor sit amet, consectetur adipisicing elit. Impedit amet labore laudantium, cumque ab quibusdam qui eligendi, sint quod rem laborum consequuntur perspiciatis! Magnam, minima velit nulla voluptatum est ratione. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Iusto, voluptates, distinctio repellendus nam dolore"})]})]})});const kv="/deploy-testes/assets/imgAdvBrenda.a2ff4f6a.jpg",$v=()=>T("div",{id:"sobre",className:"sobreContainer",children:[T("div",{className:"sobre",children:[C("h1",{children:"Sobre"}),C(xe,{triggerOnce:!0,children:C("p",{children:"Lorem, ipsum dolor sit amet consectetur adipisicing elit. Laboriosam dignissimos omnis consectetur nostrum illum. Quos repudiandae cupiditate, voluptates esse quibusdam in aspernatur odit recusandae, blanditiis libero ut, voluptatum est amet!l Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quas magni delectus, placeat, minus sunt provident quos cumque nesciunt nemo facilis odit natus saepe explicabo corrupti omnis culpa deleniti, consequuntur dicta."})})]}),C("img",{src:kv,alt:"Imagem advogada Brenda"})]});const Cv=()=>T("div",{id:"contatos",className:"containerContatos",children:[C("h1",{children:"Contato"}),C("div",{className:"esquerda"}),C("div",{className:"direita",children:T("form",{action:"https://formsubmit.co/brendasilva.silva9@gmail.com",method:"POST",target:"_blank",className:"campos",children:[T("div",{className:"nomeTelefoneEmail",children:[T("label",{className:"campo",children:["Nome",C("input",{name:"nome",type:"text",placeholder:"Digite seu nome",required:!0})]}),T("label",{className:"campo",children:["Telefone",C("input",{name:"telefone",type:"number",placeholder:"(00) 900112233",required:!0})]}),T("label",{className:"campo",children:["Email",C("input",{name:"email",type:"text",placeholder:"Digite seu email",required:!0})]})]}),T("div",{className:"descricaoEnviar",children:[T("label",{className:"campo",children:["Descri\xE7\xE3o",C("textarea",{name:"descricao",placeholder:"Minha d\xFAvida \xE9...",required:!0})]}),C("input",{className:"inputBtn",type:"submit",value:"Enviar"})]})]})})]});const Ev=()=>C("div",{className:"footerContainer",children:T("div",{className:"direitos",children:[C("p",{className:"copy",children:"\xA9 2022 BS ADVOCACIA. Todos os direitos reservados"}),T("p",{className:"dev",children:["Desenvolvido por ",T("strong",{children:[C("sup",{children:C("span",{className:"nome",children:"Alan"})})," ",C("span",{className:"sobrenome",children:"Moreira\u2122"})]})]})]})});function _v(){return C("div",{className:"App",children:T("div",{className:"appContainer",children:[C(c1,{}),C(Sv,{}),C(Cv,{}),C($v,{}),C(xe,{triggerOnce:!0,children:C(Ev,{})})]})})}al.createRoot(document.getElementById("root")).render(C(lr.StrictMode,{children:C(_v,{})}));
